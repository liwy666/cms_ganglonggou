	...
	<div class="main">
		<div class="form-box">
			<el-form ref="form" :model="form" :rules="rules" label-width="80px" size="mini">
				...
				<!--					v-show="form.position_type==='品牌TOP榜-品牌'||form.position_type==='品牌TOP榜-商品'||form.position_type==='精选推荐-小标题'||form.position_type==='精选推荐-商品'">-->
				...
				<el-form-item label="商品名称"
					v-show="form.position_type.indexOf('G')>0 || form.position_type.indexOf('文章')>0|| form.position_type.indexOf('商品')>0">
				...
				<el-form-item label="商品价格" v-show="form.position_type.indexOf('G')>0 ">
					<el-input-number v-model="form.goods_price" :min="1" :precision="2"
						:controls="false"></el-input-number>
				</el-form-item>
				<el-form-item label="文本或关键词" v-show="form.ad_type==='文本'">
		...
		<div class="img-box"><img src="../../../assets/images/tmt_mobile_ad_show.jpg"></div>
	</div>
</template>
<script>
    export default {
