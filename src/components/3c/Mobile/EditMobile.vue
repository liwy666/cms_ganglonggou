	...
	<div class="main">
		<div class="form-box">
			<el-form ref="form" :model="form" :rules="rules" label-width="80px" size="mini">
				...
				<el-form-item label="商品名称" v-show="form.position_type.indexOf('商品')>0">
				...
				<el-form-item label="商品价格" v-show="form.position_type.indexOf('商品')>0">
		...
		<div class="img-box"><img src="../../../assets/images/3c_mobile_ad_show.png"></div>
	</div>
</template>
<script>
    export default {
