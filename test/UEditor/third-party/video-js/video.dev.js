...
================================================================================ */
/**
 * The Menus component is used to build pop up menus, including subtitle and
...
vjs.Menu.prototype.createEl = function(){
  ...
  // Prevent clicks from bubbling up. Needed for Menus Buttons,
...
/**
 * Menus button with a popup for showing the volume slider.
 * @constructor
 */
...
//   var menu = new vjs.Menus(this.player_);
...
vjs.CaptionsButton = vjs.TextTrackButton.extend({
  ...
  init: function(player, options, ready){
    ...
    this.el_.setAttribute('aria-label','Captions Menus');
  }
});
...
vjs.SubtitlesButton = vjs.TextTrackButton.extend({
  ...
  init: function(player, options, ready){
    vjs.TextTrackButton.call(this, player, options, ready);
    this.el_.setAttribute('aria-label','Subtitles Menus');
  }
});
...
vjs.ChaptersButton = vjs.TextTrackButton.extend({
  ...
  init: function(player, options, ready){
    vjs.TextTrackButton.call(this, player, options, ready);
    this.el_.setAttribute('aria-label','Chapters Menus');
  }
});
