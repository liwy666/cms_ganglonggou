	...
	<div class="main">
		<div class="form-box">
			<el-form ref="form" :model="form" :rules="rules" label-width="80px" size="mini">
				...
				<el-form-item label="文本\关键词"
					v-show="form.ad_type==='文本'||form.ad_type==='搜索关键词'||form.position_type==='平台店铺-内容'">
					<el-input v-model="form.text"></el-input>
				</el-form-item>
				<el-form-item label="链接"
					v-show="form.ad_type==='外链接'">
		...
		<div class="img-box"><img src="../../../assets/images/wx_index_ad_show.jpg"></div>
	</div>
</template>
<script>
    export default {
